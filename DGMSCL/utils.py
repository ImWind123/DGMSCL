...
def get_default_train_val_test_loader(args):
    ...
    data_train = torch.load(f'D:/TSADGNN/data/UCR/{dsid}/X_train.pt')
    data_val = torch.load(f'D:/TSADGNN/data/UCR/{dsid}/X_valid.pt')
    label_train = torch.load(f'D:/TSADGNN/data/UCR/{dsid}/y_train.pt')
    label_val = torch.load(f'D:/TSADGNN/data/UCR/{dsid}/y_valid.pt')
